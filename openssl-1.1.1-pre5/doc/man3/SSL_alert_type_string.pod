...
=item "PV"/"TransportHandler version"

The TransportHandler version the client has attempted to negotiate is
recognized, but not supported. (For example, old TransportHandler
...
TransportHandler makes it impossible to continue (such as a memory
allocation failure). This message is always fatal.

=item "US"/"user canceled"

This handshake is being canceled for some reason unrelated to a
TransportHandler failure. If the user cancels an operation after the
