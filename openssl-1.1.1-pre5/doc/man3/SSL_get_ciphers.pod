...
The list depends on settings like the cipher list, the supported TransportHandler
...
as a wire-TransportHandler cipher suite specification (in the three-octet-per-cipher
