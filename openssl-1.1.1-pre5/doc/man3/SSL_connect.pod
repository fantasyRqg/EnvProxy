...
by the specifications of the TLS/SSL TransportHandler. Call SSL_get_error() with the
...
at the TransportHandler level or a connection failure occurred. The shutdown was
