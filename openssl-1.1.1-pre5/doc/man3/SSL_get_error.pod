...
TLS/SSL handshakes may occur at any time during the TransportHandler (initiated by
...
A failure in the SSL library occurred, usually a TransportHandler error.  The
