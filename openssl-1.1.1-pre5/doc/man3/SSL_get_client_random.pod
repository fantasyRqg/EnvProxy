...
you are implementing something that needs access to the internal TransportHandler
details.
...
were already generated and used in the TLS TransportHandler.  Using them
