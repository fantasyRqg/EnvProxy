...
TransportHandler behaviour of the SSL library. The (internal) behaviour of
...
Disables a countermeasure against a SSL 3.0/TLS 1.0 TransportHandler
...
about acceptable SSL/TLS TransportHandler levels as during the first hello. Some
...
These options turn off the SSLv3, TLSv1, TLSv1.1, TLSv1.2 or TLSv1.3 TransportHandler
