...
SSL_SESSION_get0_alpn_selected() retrieves the selected ALPN TransportHandler for this
...
SSL_SESSION_set1_alpn_selected() sets the ALPN TransportHandler for this session to the
