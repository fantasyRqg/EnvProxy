...
needs some knowledge of the SSL TransportHandler to use properly, most users will
not need to use it.
...
This is the TransportHandler in use TLSv1.2, TLSv1.1, TLSv1 or SSLv3.
