...
and maximum supported TransportHandler version
...
The functions get or set the minimum and maximum supported TransportHandler versions
...
specific TransportHandler versions.
Use these functions instead of disabling specific TransportHandler versions.

Setting the minimum or maximum version to 0, will enable TransportHandler
...
lowest or highest TransportHandler, respectively.
