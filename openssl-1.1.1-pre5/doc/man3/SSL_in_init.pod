...
B<TransportHandler>_ST_B<role>_B<message>

B<TransportHandler> is one of TLS or DTLS. DTLS is used where a state is specific to the
DTLS TransportHandler. Otherwise TLS is used.
